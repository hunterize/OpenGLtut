...
namespace StencilTesting
{
	...
	void StencilTesting()
	{
		...
		window = SDL_CreateWindow("Adv OpenGL - StencilTesing", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_OPENGL);
		...
		outlineShader.AttachShader("Shaders/StencilTestingVertexShader.vert", "Shaders/StencilTestingOutlineFragmentShader.frag");
		...
		while (isRunning)
		{
			...
			//draw normal cubes, write 1 to stencil buffer
