...
namespace CubeMaps
{
	...
	void CubeMaps()
	{
		...
		window = SDL_CreateWindow("Adv OpenGL - CubeMaps", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_OPENGL);
		...
		cubeShader.AttachShader("Shaders/CubeMapsObjectVertexShader.vert", "Shaders/CubeMapsObjectFragmentShader.frag");
