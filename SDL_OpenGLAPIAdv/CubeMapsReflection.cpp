...
namespace CubeMapsReflection
{
	...
	void CubeMapsReflection()
	{
		...
		window = SDL_CreateWindow("Adv OpenGL - CubeMaps Reflection", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_OPENGL);
		...
		cubeShader.AttachShader("Shaders/CubeMapsReflectionVertexShader.vert", "Shaders/CubeMapsReflectionFragmentShader.frag");
		skyShader.AttachShader("Shaders/CubeMapsSkyVertexShader.vert", "Shaders/CubeMapsSkyFragmentShader.frag");
