...
namespace GammaCorrection
{
	...
	void GammaCorrection()
	{
		...
		window = SDL_CreateWindow("GammaCorrection", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_OPENGL);
		...
		CShader woodShader;
		woodShader.AttachShader("Shaders/GammaCorrectionVertexShader.vert", "Shaders/GammaCorrectionFragmentShader.frag");

		GLTexture woodTexture = CSTexture::LoadImage("wood.png", true);
		...
		while (isRunning)
		{
			...
			//std::cout << "isGama: " << (isGamma ? "true" : "false") << std::endl;
			...
			woodShader.SetUniformVec3Array("lightPosition", lightPosition, 3);
			woodShader.SetUniformVec3Array("lightColor", lightColor, 3);
			woodShader.SetUniformVec3("eyePos", eyePos);
			woodShader.SetUniformFloat("shininess", shininess);
			woodShader.SetUniformInt("isGamma", isGamma);
