...
void AdvancedModel()
{
	...
	window = SDL_CreateWindow("ModelEx", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, screenWidth, screenHeight, SDL_WINDOW_OPENGL);
	...
	skyShader.AttachShader("Shaders/SkyVertexShaderEx.vert", "Shaders/SkyFragmentShaderEx.frag");
	soldierShader.AttachShader("Shaders/ModelVertexShaderEx.vert", "Shaders/ModelFragmentShaderEx.frag", "Shaders/ModelGeometryShaderEx.geom");
	furShader.AttachShader("Shaders/ModelVertexShaderEx.vert", "Shaders/FurFragmentShaderEx.frag", "Shaders/FurGeometryShaderEx.geom");
	...
	//stb_image support 16bit TGA format
	skyTexture.ID = CSTexture::LoadCubeMaps("GameResource/skybox/drakeq_ft.tga",
		"GameResource/skybox/drakeq_bk.tga",
		"GameResource/skybox/drakeq_up.tga",
		"GameResource/skybox/drakeq_dn.tga",
		"GameResource/skybox/drakeq_lf.tga",
		"GameResource/skybox/drakeq_rt.tga");
	...
	while (isRunning)
	{
		...
		soldierShader.SetUniformVec3("lightColor", lightColor);
		...
		if (inputManager.IskeyPressed(SDLK_1))
			soldierShader.SetUniformInt("eff", 1);
		if (inputManager.IskeyPressed(SDLK_2))
			soldierShader.SetUniformInt("eff", 2);
